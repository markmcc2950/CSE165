...
public: 
	TextBox() : text(), x(0), y(0) {}
	TextBox(string text, float x, float y) : text(text), x(x), y(y) {}
	TextBox(string text, float x, float y, void* font, float r, float g, float b) : text(text), x(x), y(y), font(font), r(r), g(g), b(b) {}
...
int main(int argc, char** argv) {
	...
	shapes.push_back(new TextBox("Mark's Test", 0.0, 0.5, GLUT_BITMAP_HELVETICA_12, 1.0, 0.0, 0.0));
